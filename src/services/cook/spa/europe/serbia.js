      ...
      sectionPreparation: [
        {
          title: 'Preparación:',
          preparation: [
            'Mezclar las yemas con el azúcar, hasta obtener una crema espumosa.',
            'Añadir, las almendras picadas, la fruta confitada y la harina.',
            'Fundir el chocolate en un poco de leche e incorporar en ella la mezcla obtenida previamente.',
            'Batir las claras a punto de nieve y mezclarlo todo con cuidado, hasta obtener una mezcla homogénea.',
            'Verter el resultado en un molde previamente untado con la mantequilla, ponerlo todo al horno y dejarlo allí durante 3⁄4 de hora.',
