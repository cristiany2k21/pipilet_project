      ...
      sectionIngredient: [
        {
          title: "Ingredientes:",
          ingredient: [
            "115 g (1⁄2 cup) de mantequilla sin sal",
            "115 g (1⁄2 cup + 1 cucharada) de azúcar superfino",
            "2 huevos",
            "1 cucharadita de extracto puro de vainilla",
            "115 g (7⁄8 cup) de harina de trigo (self-raising flour)",
      ...
      sectionPreparation: [
        {
          title: "Preparación:",
          preparation: [
            "Precalentamos el horno (eléctrico) a 180oC y colocamos la rejilla a media altura.",
            ...
            "Añadimos el extracto de vainilla y mezclamos hasta integrar. Ahora añadimos la harina en 2 tandas y mezclamos lo justo hasta que prácticamente no quede rastro de ella.",
            ...
            "Con ayuda de una cuchara de helado, rellenamos las cápsulas hasta 2⁄3 de su capacidad.",
            "Horneamos durante 18-20 minutos o hasta que hayan subido y adquirido un tono dorado.",
            "Comprobaremos si están hechos cuando al insertar una brocheta (o cake tester) en el centro ésta limpia de masa o migas.",
