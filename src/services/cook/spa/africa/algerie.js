      ...
      sectionIngredient: [
        {
          ...
          ingredient: [
            ...
            '1 cuchara grande de margarina a temperatura ambiente',
      ...
      sectionPreparation: [
        {
          title: 'Receta:',
          preparation: [
            'Utilizar un molde de cristal.',
            'En un recipiente apto para microondas, derretir la mantequilla y el chocolate cortado en trozos hasta que se funda, retirar y añadir los huevos, el azúcar y el cacao en polvo. Batir bien.',
            'Poner una capa de esta mezcla en el fondo del molde cubrir con una capa de galletas, por capa así sucesivamente acabando con una capa de chocolate.',
            'Una vez terminada, ponerla en el frigorífico hasta que quede bien consistente.',
          ],
        },
      ],
    },
