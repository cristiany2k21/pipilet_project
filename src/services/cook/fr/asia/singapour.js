			...
			sectionPreparation: [
				{
					...
					preparation: [
						...
						'Choisir les noisettes coupées grossièrement. Dans une coupe, servir un peu de glace à lavanille, une bonne portion de purée de pêches, et enfin une poignée de noisettes. Servir immédiatement.'
					]
				}
			]
		},
