...
export const presentation =
  <div id="wrapper-text-image">
    <div className="wrapper-text">
      ...
      <p>
        My name is <span className="red">Pipilet Mandala</span> and I have just landed on Earth.
        I am an <span className="purple">alien snail</span>,
        I come from <span className="green">Planet Galappar</span>, the planet of <span className="red">music</span>, <span className="blue">colours</span> and <span className="red">love</span>.
      </p>
      <p>
        I can’t speak as I only communicate through
        music and <span className="blue">colour</span> . Instead of writing, I <span className="orange">sing</span> and <span className="purple">peint</span>. I am a magic snail!!!
      </p>
      <p>
        I would really like to know you and for you <span className="green">to be my friend</span>. I love having friends all over the
      ...
      <p>
        <span className="green">I always travel with my guitar and my shell which is a mandala and a backpack</span>. In
        it, I put<span className="orange"> music</span>, <span className="blue">colours</span> and lots of <span className="red">love</span>.
