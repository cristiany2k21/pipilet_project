...
const DisplayLanguageSong = ({
	...
	<div id="wrapper-language">
		<div className="wrapper-display-language">
			<img src={note1} className="absolute-language note1" alt="note1"/>
			<img src={note2} className="absolute-language note2" alt="note2"/>
			<img src={note3} className="absolute-language note3" alt="note3"/>
			<img src={note4} className="absolute-language note4" alt="note4"/>
			<img src={note1} className="absolute-language note5" alt="note1"/>
			<img src={note4} className="absolute-language note6" alt="note4"/>
			<img src={note3} className="absolute-language note7" alt="note3"/>
			<img src={note1} className="absolute-language note8" alt="note1"/>
